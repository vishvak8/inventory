...
def weight_comparision_display(athlete):
...
def data_processing():
    try:
        ...
        result_label.config(text=f"{weight_comparision_display(athlete_data)}\n\nCost Summary for {athlete_data['name']}:\n{cost_calculation(athlete_data)}")
    except ValueError:
        messagebox.showerror("Error", "Invalid input. Please enter valid numeric values.")

# Tkinter window being created
window = tk.Tk()
...
calculate_button = tk.Button(window, text="Calculate", command=data_processing)
